...
export const aboutPage: AboutPageData = {
	hero: {
		...
		badges: [
			...
			{ label: "Zadowolonych gości", value: "150 000+" },
		],
	},
	founder: {
	...
	experience: {
		...
		story: [
			...
			"Jako młoda osoba bez doświadczenia w biznesie miałam ogromne szczęście spotkać na swojej drodze mądrych, inspirujących ludzi, od których uczyłam się, jak prowadzić firmę. Najważniejszym z nich był — i jest — mój mąż. Równie ważni byli współpracownicy, którzy od pierwszych miesięcy pokazywali mi, że razem tworzymy tę firmę i razem jesteśmy za nią odpowiedzialni.",
		...
		timeline: [
			...
			{
				year: "2024 – dziś",
				title: "18 lat nieprzerwanej receptury",
