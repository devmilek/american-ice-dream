...
export const products: Product[] = [
  {
    ...
    description:
      "Ciesz się aksamitnymi lodami włoskimi, które wyróżniają się kremową konsystencją i wyjątkowym smakiem. Nasza niezmienna od 2006 roku receptura gwarantuje niezapomniane doznania smakowe — każda porcja to dzieło rzemieślnika, serwowane wprost z klasycznej maszyny Carpigiani.",
