...
export function HeroCone(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 400 520" aria-hidden {...props}>
      ...
      <ellipse cx="200" cy="498" rx="130" ry="14" fill="#0f2d5c" opacity="0.12" />
      <g>
        <path d="M110 275 L200 490 L290 275 Z" fill="url(#cone)" stroke="#6b3a1f" strokeWidth="2" />
      ...
      <g>
        ...
        <path d="M108 265 Q200 215 292 265 Q200 290 108 265Z" fill="url(#swirlDark)" />
        <path d="M120 240 Q200 198 280 240 Q200 262 120 240Z" fill="url(#swirlLight)" />
        <path d="M132 215 Q200 180 268 215 Q200 234 132 215Z" fill="url(#swirlDark)" />
        <path d="M144 190 Q200 160 256 190 Q200 206 144 190Z" fill="url(#swirlLight)" />
        <path d="M154 165 Q200 140 246 165 Q200 178 154 165Z" fill="url(#swirlDark)" />
        <path d="M164 140 Q200 120 236 140 Q200 150 164 140Z" fill="url(#swirlLight)" />
        <path d="M178 118 Q200 92 222 118 Q200 126 178 118Z" fill="url(#swirlDark)" />
        <path d="M188 100 Q200 80 212 100 Q200 108 188 100Z" fill="url(#swirlLight)" />
        <circle cx="200" cy="80" r="6" fill="#f1d98a" stroke="#6b3a1f" strokeWidth="1" />
        <ellipse cx="160" cy="220" rx="36" ry="60" fill="url(#shine)" />
      </g>
      <g className="[&>*]:origin-center">
        <rect x="60" y="180" width="14" height="4" rx="2" fill="#3cb6e3" transform="rotate(-20 67 182)" />
        <rect x="340" y="210" width="14" height="4" rx="2" fill="#c19a5b" transform="rotate(30 347 212)" />
        <rect x="80" y="330" width="12" height="4" rx="2" fill="#0f2d5c" transform="rotate(40 86 332)" />
        <rect x="330" y="320" width="12" height="4" rx="2" fill="#e06b6b" transform="rotate(-30 336 322)" />
...
export function ItalianCone(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 200 260" aria-hidden {...props}>
      ...
      <path d="M60 130 L100 250 L140 130 Z" fill="#a56e2b" stroke="#6b3a1f" strokeWidth="1.5" />
      <g stroke="#6b3a1f" strokeWidth="1" fill="none" opacity="0.7">
        <path d="M72 150L128 150" />
        <path d="M80 175L120 175" />
        <path d="M88 200L112 200" />
      </g>
      <path d="M40 130 Q100 60 160 130 Q100 150 40 130Z" fill="url(#pIceL)" stroke="#d6b660" strokeWidth="1" />
      <path d="M50 110 Q100 50 150 110 Q100 128 50 110Z" fill="url(#pIceL)" stroke="#d6b660" strokeWidth="1" />
      <path d="M60 90 Q100 40 140 90 Q100 106 60 90Z" fill="url(#pIceL)" stroke="#d6b660" strokeWidth="1" />
      <path d="M70 70 Q100 35 130 70 Q100 82 70 70Z" fill="url(#pIceL)" stroke="#d6b660" strokeWidth="1" />
      <path d="M80 52 Q100 30 120 52 Q100 62 80 52Z" fill="url(#pIceL)" stroke="#d6b660" strokeWidth="1" />
...
export function SoftServe(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 160 220" aria-hidden {...props}>
      <path d="M50 110 L80 210 L110 110 Z" fill="#a56e2b" stroke="#6b3a1f" strokeWidth="1.5" />
...
export function Sundae(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 180 220" aria-hidden {...props}>
      <path d="M35 85 L145 85 L120 200 L60 200 Z" fill="#fdfaf2" stroke="#0f2d5c" strokeWidth="1.5" />
      <rect x="74" y="200" width="32" height="8" fill="#0f2d5c" />
      <rect x="60" y="208" width="60" height="6" fill="#c19a5b" />
      <circle cx="70" cy="70" r="22" fill="#f7c7c7" stroke="#0f2d5c" strokeWidth="1" />
      <circle cx="108" cy="65" r="24" fill="#9ad2b6" stroke="#0f2d5c" strokeWidth="1" />
      <circle cx="90" cy="50" r="20" fill="#f1d98a" stroke="#0f2d5c" strokeWidth="1" />
      <rect x="120" y="28" width="6" height="38" rx="1" fill="#a56e2b" transform="rotate(20 123 47)" />
      <path
...
export function Granita(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 160 220" aria-hidden {...props}>
      <path d="M30 40 L130 40 L115 200 L45 200 Z" fill="#fee3e3" stroke="#0f2d5c" strokeWidth="1.5" />
      ...
      <rect x="86" y="20" width="6" height="70" fill="#3cb6e3" transform="rotate(12 89 55)" />
      <rect x="86" y="20" width="6" height="16" fill="#0f2d5c" transform="rotate(12 89 28)" />
      <path d="M110 44 q8 -4 14 2 q0 10 -10 14 q-10 -4 -4 -16z" fill="#c03b3b" />
      <path d="M110 44 q2 -6 10 -8" fill="none" stroke="#2a8b55" strokeWidth="2" />
    </svg>
  );
}
...
export function CreamRoll(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 200 160" aria-hidden {...props}>
      <path d="M20 80 L180 40" stroke="#a56e2b" strokeWidth="38" strokeLinecap="round" />
      <path
        d="M30 78 L170 44"
        stroke="#7e4f1b"
        strokeWidth="2"
        ...
        strokeDasharray="2 6"
      />
      <circle cx="178" cy="42" r="22" fill="#fffaf0" stroke="#d6b660" strokeWidth="1.2" />
      <circle cx="186" cy="30" r="14" fill="#fffaf0" stroke="#d6b660" strokeWidth="1.2" />
      <circle cx="172" cy="26" r="12" fill="#fffaf0" stroke="#d6b660" strokeWidth="1.2" />
      <circle cx="194" cy="16" r="9" fill="#fffaf0" stroke="#d6b660" strokeWidth="1.2" />
      <circle cx="194" cy="8" r="5" fill="#c03b3b" />
      <path d="M194 3 q6 -8 12 -6" stroke="#2a8b55" strokeWidth="2" fill="none" />
    </svg>
  );
}
...
export function CoffeeCup(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 180 200" aria-hidden {...props}>
      <path d="M30 70 L140 70 L128 180 L42 180 Z" fill="#fdfaf2" stroke="#0f2d5c" strokeWidth="1.5" />
      <path d="M140 80 q28 6 24 34 q-2 22 -30 26" fill="none" stroke="#0f2d5c" strokeWidth="3" />
      <ellipse cx="85" cy="72" rx="55" ry="7" fill="#6b3a1f" />
      <path d="M85 72 q-10 -6 -10 0 q0 6 10 10 q10 -4 10 -10 q0 -6 -10 0z" fill="#fffaf0" />
      <g stroke="#0f2d5c" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.4">
  ...
  return (
    <svg viewBox="0 0 300 300" aria-hidden {...props}>
      <g transform="rotate(-8 150 150)">
        <rect x="40" y="60" width="220" height="130" rx="16" fill="#fbf6ec" stroke="#c19a5b" strokeWidth="2" />
        <text x="60" y="98" fontFamily="var(--font-fraunces)" fontSize="22" fill="#0f2d5c" fontWeight="700">
          LODOJADY
        </text>
        <text x="60" y="118" fontFamily="var(--font-caveat)" fontSize="16" fill="#3cb6e3">
        ...
        <g transform="translate(56 140)">
          ...
          <circle cx="104" r="10" fill="#fbf6ec" stroke="#c19a5b" strokeWidth="2" />
          <circle cx="130" r="10" fill="#fbf6ec" stroke="#c19a5b" strokeWidth="2" />
          <circle cx="156" r="10" fill="#fbf6ec" stroke="#c19a5b" strokeWidth="2" />
        </g>
      </g>
      <g transform="translate(195 30) rotate(15)">
        <path d="M0 40 L20 100 L40 40 Z" fill="#a56e2b" stroke="#6b3a1f" strokeWidth="1.5" />
        <ellipse cx="20" cy="40" rx="26" ry="10" fill="#fff4c4" stroke="#d6b660" />
        <path d="M-4 38 Q20 20 44 38 Q20 30 -4 38Z" fill="#fff4c4" stroke="#d6b660" />
        <path d="M4 26 Q20 12 36 26 Q20 22 4 26Z" fill="#fff4c4" stroke="#d6b660" />
  ...
  return (
    <svg viewBox="0 0 600 600" aria-hidden {...props}>
      ...
      <circle
        ...
        filter="url(#wiggle)"
      />
      <circle cx="300" cy="300" r="250" fill="none" stroke="#c19a5b" strokeWidth="1.2" opacity="0.55" />
    </svg>
  );
}
...
export function MapMock(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 1200 520" preserveAspectRatio="xMidYMid slice" aria-hidden {...props}>
      <defs>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M0 180 Q300 200 600 170 T1200 200" fill="none" stroke="#fff" strokeWidth="6" />
      <path d="M200 0 Q230 260 160 520" fill="none" stroke="#fff" strokeWidth="4" />
      <path d="M820 0 Q780 240 860 520" fill="none" stroke="#fff" strokeWidth="4" />
      <ellipse cx="350" cy="420" rx="90" ry="40" fill="#d5e7c8" opacity="0.9" />
      <ellipse cx="980" cy="120" rx="120" ry="50" fill="#d5e7c8" opacity="0.9" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 64 64" aria-hidden {...props}>
      <path
        ...
        strokeWidth="2"
      />
      <path d="M26 46h12M26 50h12" stroke="#c19a5b" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function FeatureIconHeritage(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 64 64" aria-hidden {...props}>
      <circle cx="32" cy="32" r="24" fill="#fdfaf2" stroke="#0f2d5c" strokeWidth="2" />
      <path
        d="M32 18v14l10 6"
        stroke="#c19a5b"
        strokeWidth="2.4"
        ...
        fill="none"
      />
      <path d="M20 12l4 4M44 12l-4 4" stroke="#0f2d5c" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
