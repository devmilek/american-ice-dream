      ...
      <div className="container-page">
        ...
        >
          <span id="products-title">
            Rozsmakuj się w&nbsp;naszych{" "}
            <ScriptAccent>specjałach</ScriptAccent>
          </span>
        </SectionHeading>
...
function ProductCard({ product }: { product: Product }) {
  const { title, tag, description, meta, accent, Illustration, photo, featured } =
    product;
  return (
    <article
      className={cn(
        ...
        "lg:col-span-2",
        featured &&
          "sm:col-span-2 lg:col-span-3 lg:row-span-2 lg:grid lg:grid-cols-[0.95fr_1.05fr]",
      )}
    ...
    >
      ...
      <div
        className={cn(
          ...
          featured &&
            "lg:border-b-0 lg:border-r lg:border-dashed",
      ...
      <div className="flex flex-1 flex-col px-6 pt-6 pb-7 sm:px-8 sm:pt-7 sm:pb-8">
        ...
        <p
          className={cn(
            ...
            featured ? "text-[15.5px] lg:text-[16.5px]" : "text-[14.5px] sm:text-[15px]",
          )}
        >
          {description}
        </p>
