...
export function LocationLodojadyCta({ location, details }: Props) {
	return (
		<section
			id="lodojady"
					...
					<div className="relative grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
						<div>
							...
							<h2
								...
								className="mt-4 mb-5 font-display text-[clamp(1.9rem,3.6vw+0.8rem,3.25rem)] leading-[1.04] tracking-[-0.02em]"
							>
								Dołącz do{" "}
							...
							<ul className="mb-8 grid gap-2.5 text-[14.5px] text-cream/85 sm:grid-cols-2">
								...
								<BulletRow>Wcześniejszy dostęp do nowych smaków</BulletRow>
						...
						<div className="flex flex-col items-center gap-4">
							<div className="relative">
								<div className="rounded-[24px] border border-gold/40 bg-paper p-4 shadow-[0_30px_70px_-30px_rgba(0,0,0,0.5)]">
									<QrPlaceholder
										seed={`aid-${details.slug}`}
										size={200}
										fg="#0f2d5c"
										bg="#fdfaf2"
										title={details.lodojady.qr.alt}
