...
export function Navigation() {
  return (
    <header className="sticky top-0 z-50 border-b border-navy/8 bg-cream/88 backdrop-blur-md backdrop-saturate-150">
      <div className="container-page flex items-center justify-between gap-4 py-3 md:gap-6 md:py-3.5">
        <Link
          href="/"
