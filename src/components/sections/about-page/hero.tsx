...
export function AboutHero({ data }: { data: AboutPageData }) {
	...
	return (
		...
		>
			<LocationBreadcrumb
				className="mx-auto flex justify-center pt-0"
				crumbs={[{ href: "/", label: "Strona główna" }, { label: "O nas" }]}
			/>
			<div
				...
				<figure className="relative flex items-center justify-center">
					...
					<div className="relative z-1 flex flex-col items-center gap-5">
						<div className="relative">
							...
							/>
							<div className="relative h-[340px] w-[340px] overflow-hidden rounded-2xl border-4 border-paper shadow-[0_30px_70px_-30px_rgba(15,45,92,0.4)] max-lg:h-[230px] max-lg:w-[230px]">
								<Image
									...
									className="object-contain bg-cream-deep/60"
								/>
							</div>
						</div>
